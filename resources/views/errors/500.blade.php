...
<body class="bg-slate-100 h-screen flex justify-center items-center">
    <div>
        <h1 class="text-slate-900 text-5xl font-extrabold">500 SERVER ERROR</h1>
        <p class="text-slate-500 my-1">Server bermasalah, <br> silahkan coba lagi beberapa saat!</p>
