...
<body class="bg-slate-100 flex flex-wrap h-screen content-center justify-center" x-data="auth" x-cloak>
            ...
            <form action="{{ url('register') }}" method="post" @submit="match()">
                ...
                <div class="relative">
                    <input type="nama" name="name" value="{{ old('name') }}"
                        class="pl-11 bg-slate-200 py-2 mb-2 px-2 w-full" required> <br>
                ...
                <div class="relative">
                    <input type="email" name="email" class="pl-11 bg-slate-200 py-2 mb-2 px-2 w-full" required> <br>
                ...
                <div class="relative" x-transition>
                    <input :type="!isVisible1 ? 'password' : 'text'" id='pass1' x-model="FirstPASS" name="password"
                        class="pl-11 bg-slate-200 py-2 px-2 w-full" required>
                ...
                <div class="relative" x-transition>
                    <input :type="!isVisible2 ? 'password' : 'text'" x-model="SecondPASS" id='pass2'
                        name="ulangi-password" class="pl-11 bg-slate-200 py-2 px-2 w-full" required>
                    <img src="assets/pass.svg" class="absolute w-6 top-2 left-3" alt="">
