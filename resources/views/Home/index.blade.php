...
@endsection
@section('content')
    <section class="md:w-4/5" x-data="home" x-init="getSorted">
...
@section('sidebar')
    ...
    <section x-data="home">
        ...
        <ul class="py-2 ml-5" x-show="sortedBy" x-transition>
            <li class="my-1 text-slate-600" x-on:click="getSorted"><input type="radio" x-model='type' name="radio"
                    value="terbaru" id="terbaru"> <label for="terbaru">
                    Terbaru</label></li>
            <li class="my-1 text-slate-600" x-on:click="getSorted"><input type="radio" x-model='type' name="radio"
                    value="terlama" id="terlama"> <label for="terlama">
                    Terlama</label></li>
        </ul>
    </section>
